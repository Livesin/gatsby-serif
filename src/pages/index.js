  ...
  return (
    <Layout bodyClass="page-home">
      ...
      <Helmet>
        <meta
          name="description"
          content="Аккуратный ремонт компьтеров ноутбуков в Одессе☑Ремонт за 30 минут при вас✓Стоимость от 350 грн✓Сервисный центр Технарь☎ +38(091)6090993. Заходите!."
        />
      </Helmet>
          ...
          <div className="container pt-6 pb-6 pb-md-10">
            ...
            <div className="row justify-content-center">
              <div className="col-auto">
                <Link className="button button-primary" to="/services/">Просмотреть все услуги</Link>
              </div>
            </div>
          </div>
        </div>
